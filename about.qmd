---
title: "About"
image: ./assets/img/kai_ohlhus.png
about:
  template: jolla  # https://quarto.org/docs/websites/website-about.html#templates
  links:
    - icon: envelope-at
      text: k.ohlhus@gmail.com
      href: mailto:k.ohlhus@gmail.com
    
    - icon: orcid
      text: ORCID
      href: https://orcid.org/0000-0003-3915-953X

    - icon: github
      text: GitHub
      href: https://github.com/siko1056

    - icon: gitlab
      text: GitLab
      href: https://gitlab.com/siko1056

    - icon: code-slash
      text: Savannah
      href: https://savannah.gnu.org/users/siko1056
    
    - icon: sourceforge
      text: SourceForge
      href: https://sourceforge.net/u/siko1056/profile
    
    - icon: wikipedia
      text: Wikipedia
      href: https://en.wikipedia.org/wiki/User:Siko1056

    - icon: instagram
      text: Instagram
      href: https://www.instagram.com/siko1056_
    
    - icon: linkedin
      text: LinkedIn
      href: https://www.linkedin.com/in/siko1056
---

Kai T. Ohlhus holds a PhD in Computer Science
and is a Free and Open Source enthusiast living and working in Japan.

<details style="text-align: left;">
<summary>My PGP Public Key (ID: 0xBD46BBCE)</summary>
